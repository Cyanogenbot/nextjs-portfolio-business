...
const cards = [
    ...
    URL:"/images/data.jpg",
    description:<><p>{"During my bachelors I would argue Business & Entrepreneurship was about finding a target group, and being able to design a product that caters to them, while figuring out a way of monetisation. "} </p>
    ...
    <p>{"Not only did I discuss the societal relevance of privacy in the Claude project, as my project also looked into further ethical explorations caused by private file-sharing and communication. Namely the complex topic of CASM, and the distribution of illegal files. As I have talked with two experts on this topic to figure out how I could take a stance on the matter"} </p>
    </>
    },
    {
