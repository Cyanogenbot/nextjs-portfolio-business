...
import { Adobeillustrator, Adobelightroom, Adobeindesign, Adobephotoshop, Blender, Cplusplus, Nextdotjs, Processingfoundation, Python } from 'styled-icons/simple-icons';
...
export default function Buffertext(props) {
  return (
    ...
    <Typography variant="h4" component="h3" color="white">{"Including the following hardskills"}</Typography>
    <Grid  marginTop = "5vh" marginBottom = "1vh" container spacing={1} justifyContent="center">
        <Grid item xs={1} md={1}>
            <Illust/>
        </Grid>
        <Grid item xs={1} md={1}>
