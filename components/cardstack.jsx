...
const cards = [
    ...
    description:<p>{"Polaris is a speculative design exploration into creating more awareness around power use through multimodal ambient interfaces. This design was created to help homeowners become more energy independent by helping them stay within their energy generation capacity. The polari can be attached to cables of appliances and monitor their power draw, in case too much power is drawn, they sonify their power use and guide homeowners to decide which appliances to turn off."}<p></p>{"The polaris project was a tough lesson into teamwork. Whereas the group was always on good terms, we seemed to have trouble defining our project and would not make decisions. I personally learnt here that my flexibility can sometimes be confusing to my team. With the takeaway that I should take more care guiding others through my decision process so that everyone can be on board. Polaris also was one of the first projects that I created with a decentralised nature as it consists of a set of devices that work together"}</p>
    },
    {
    title: "Sjef",
    URL: '/images/sjef.jpg',
    description: <p>{"Sjef is aimed at supplying convenience. It does this by allowing the user to remotely control and monitor from elsewhere in the home. Sjef is connected to a smart pan/lid and as it collects information from the pan, it transfers this to the user. The body of Sjef starts shaking according to the boiling behavior in the pan. The transparent ball holds liquid that will start shaking and so bubbles indicate the boiling intensity. Sjef works together with Cherry for emergent phenomena"}<p></p>{"This project was done for the course: Designerly Perspective on IoT, which taught us on how to design rich interaction products for growing systems. Putting the emphasis on combining multiple devices to create an unifying experience. In this course I learnt to design from a holistic perspective, in which devices we're merely tools to support the entire experience."}</p>
    },
    {
